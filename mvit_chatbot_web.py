...
<head>
    ...
    <style>
        ...
        #chatbox { width: 100%; max-width: 600px; margin: auto; background: #fff; padding: 20px; border-radius: 10px; }
...
<body>
    ...
    <script>
        function send() {
            ...
            chatlog.innerHTML += "<div class='message user'><strong>You:</strong> " + user_input + "</div>";
